    ...
    sources(tryTargets = tryTargets) {
        main {
            ...
            dependency(projectOrMavenDashPlatform("com.lightningkite", "mirror-runtime", versions.getProperty("mirror")) {
                isJvm uses projectOrMaven("com.lightningkite", "mirror-runtime-jvm", versions.getProperty("mirror"), ":mirror-runtime")
            })
            dependency(projectOrMavenDashPlatform("com.lightningkite", "mirror-archive-api", versions.getProperty("mirror")) {
                isJvm uses projectOrMaven("com.lightningkite", "mirror-archive-api-jvm", versions.getProperty("mirror"), ":mirror-archive-api")
            })
